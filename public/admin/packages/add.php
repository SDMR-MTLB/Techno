...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $adminId = $_SESSION['admin_id']; // Partner admin ID
    ...
    if (empty($errors)) {
        ...
        if ($stmt->execute([$adminId, $name, $description, $price ?: null, $inclusions, $status])) {
            header('Location: ' . BASE_URL . '/admin/packages/index.php?added=1');
            exit;
        } else {
...
<div class="max-w-2xl mx-auto">
    <div class="mb-6">
        ...
        <p class="text-gray-500 dark:text-gray-400 mt-1">Create a new service package for your customers.</p>
    </div>
    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        ...
        <form method="post">
            ...
            <div class="flex justify-end gap-3">
                ...
                <button type="submit" class="px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-lg transition-all-200">Create Package</button>
            </div>
        </form>
    </div>
</div>
